...
<head>
  ...
  <link rel="stylesheet" href="../style/viewDetails.css"/>
      ...
      <div id="MainStartingImg" class="BigImg">
        <div class="BigImg-wrapper" layout="row" layout-align="center center">
          <div layout="column">
            ...
            session_start();
            $searchQuery = $_POST['selectedCompany'];
            $_SESSION['result'] = sqlExec("Exec departments_of_company @name=$searchQuery");
            ...
            printTableWithCarryon( $_SESSION['result']);
