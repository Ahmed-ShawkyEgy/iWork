...
// Staff Member view his/her requests
    ...
    <div class="container " style="margin-top:100px; ">
        ...
        <form class="form-horizontal col-xs-8" style="margin-top:50px;" action="/Database-Project/php/Staff-Member-Controller/reply.php" method="post">
            ...
            <br>
            <?php
                echo '<button name = "id" class="btn btn-primary" value="'.$_POST["id"].'" type="submit">Reply</button>';
            ?>
        </form>
    </div>
</body>
