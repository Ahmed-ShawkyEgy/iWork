...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="/Database-Project/style/profileinfo.css">
  ...
  <a href="#"><img class="smaller-image thick-green-border" src="http://sguru.org/wp-content/uploads/2017/06/cool-profile-pictures-8DtpgWJB_400x400.jpeg" alt="A cute orange cat lying on its back. "></a>
    ...
    <div id="box1" class="box blurred-bg tinted">
      <div class="content">
        ...
        $result=sqlExec("Exec all_possible_information @username='".$username."'");
        printTableDateTime($result);
        ?></h2>
    	      </div>
    </div>
    <div id='stretch'></div>
