...
<div id="Main" class="container-fluid">
  ...
  <a href="#"><img class="smaller-image thick-green-border" src="http://sguru.org/wp-content/uploads/2017/06/cool-profile-pictures-8DtpgWJB_400x400.jpeg" alt="A cute orange cat lying on its back. "></a>
    ...
    <!--  <div class="content">-->
        ...
        $_SESSION['projx']=post('searchOption');
        $result=sqlExec("Exec View_Task @username='".$username."',@project=$searchOption");
        $filepath='/Database-Project/php/Regular-Employee-Controller/changetoAssigned.php';
