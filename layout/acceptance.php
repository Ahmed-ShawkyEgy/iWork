...
<head>
    ...
    <link rel="stylesheet" href="../style/acceptance.css">
...
<body>
    <div id="Main" class="container-fluid">
        ...
        <div id="RowStarter" class="row">
            ...
            if($_SESSION['accept'] === null)
                $_SESSION['accept'] = "Undefined Error";
    ...
    <div id="footer">
        <footer class="col-md-12">
            ...
            <div id="FooterText">
                <ul id="ulLinkList">
                    <li>Copyrights &copy; Team XIII 2017. This page was created for educational purposes only as a project for GUC.</li>
                </ul>
            </div>
        </footer>
    </div>
